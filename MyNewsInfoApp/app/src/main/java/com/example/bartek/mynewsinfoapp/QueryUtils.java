    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                try {
                    publicationDate = (new SimpleDateFormat("yyyy-MM-dd")).parse(originalPublicationDate);
                } catch (Exception e) {
                ...
                if (!tags.isNull(0)) {
                    ...
                    authorFullName = String.valueOf(authorFirstName.toLowerCase().trim()) + " " + String.valueOf(authorLastName.toLowerCase().trim());
                ...
                News news = new News(title, sectionName, authorFullName, url, publicationDate);
